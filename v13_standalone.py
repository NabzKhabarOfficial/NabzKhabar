...
STRICT_LOW_VALUE_TERMS = (
    ...
    "جشنواره فیلم", "قرعه کشی", "قرعه‌کشی",
...
STRICT_EVENT_ACTIONS = (
    "کشته", "زخمی", "مفقود", "بازداشت", "دستگیر", "تخلیه", "هدف قرار",
    "هدف قرار گرفت", "هدف قرار داد", "مورد حمله قرار گرفت", "تشدید حملات",
    "تهدید کرد", "شلیک", "پرتابه", "توقف",
...
STRICT_CONCRETE_EVENT_RE = re.compile(
    ...
    r"هدف قرار|مورد حمله قرار|تشدید حملات|عملیات نظامی|
